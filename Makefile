...
setup-dev: ## Install the development dependencies
	@echo "\033[36mInstalling the development dependencies...\033[0m"
	@pip3 install -r requirements-dev.txt
	@echo "\033[36mDevelopment dependencies installed!\033[0m"
...
require: ## Update the requirements.txt file
	@echo "\033[36mUpdating the requirements.txt file...\033[0m"
	@pip3 freeze > requirements.txt
	@echo "\033[36mRequirements.txt file updated!\033[0m"
